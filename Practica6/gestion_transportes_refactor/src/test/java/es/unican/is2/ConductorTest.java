...
public class ConductorTest {
	...
	public void testConstructor() {
		...
		assertEquals("Avda. de los Castros s/n", sut.getDireccion()); // getDire() renombrado a getDireccion()
	...
	public void testSueldoYAnhadeTransporte() {
		...
		// Instanciamos usando el polimorfismo en lugar de pasar el enumerado
